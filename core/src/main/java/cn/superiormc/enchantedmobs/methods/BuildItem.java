    ...
    public static ItemStack editItemStack(ItemStack item,
        ...
        if (materialKey != null) {
            ...
            if (pluginName != null && itemID != null) {
                ...
                item = EnchantedMobs.methodUtil.getItemObject(itemThing);
            }
        }
        ...
        if (displayNameKey != null) {
            EnchantedMobs.methodUtil.setItemName(meta, CommonUtil.modifyString(player, displayNameKey, args), player);
        }
        ...
        if (CommonUtil.getMinorVersion(20, 5)) {
            ...
            if (itemNameKey != null) {
                EnchantedMobs.methodUtil.setItemItemName(meta, CommonUtil.modifyString(player, itemNameKey, args), player);
            }
        }
        ...
        if (!lores.isEmpty()) {
            EnchantedMobs.methodUtil.setItemLore(meta, CommonUtil.modifyList(player, lores, args), player);
        }
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (skullTextureNameKey != null) {
                ...
                if (skullTextureNameKey.length() > 16) {
                    EnchantedMobs.methodUtil.setSkullMeta(skullMeta, skullTextureNameKey);
                } else {
        ...
        if (meta instanceof BlockStateMeta) {
            ...
            if (state instanceof CreatureSpawner) {
                ...
                if (spawnerKey != null) {
                    ...
                    if (EnchantedMobs.methodUtil.methodID().equals("paper") && CommonUtil.getMinorVersion(20, 5) && entityType == EntityType.ITEM) {
        ...
        if (componentKey != null) {
            item = EnchantedMobs.methodUtil.editItemStack(item, player, componentKey, -1, args);
        }
