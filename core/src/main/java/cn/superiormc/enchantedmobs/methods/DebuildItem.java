...
public class DebuildItem {
    ...
    public static ConfigurationSection debuildItem(ItemStack itemStack, ConfigurationSection section) {
        ...
        if (EnchantedMobs.methodUtil.methodID().equals("paper") &&
            ...
            section.set("component", EnchantedMobs.methodUtil.serializeItemStack(itemStack));
        } else {
            ...
            if (meta.hasDisplayName()) {
                section.set("name", EnchantedMobs.methodUtil.getItemName(meta));
            }

            // Item Name
            if (CommonUtil.getMinorVersion(20, 5)) {
                if (meta.hasItemName()) {
                    section.set("item-name", EnchantedMobs.methodUtil.getItemItemName(meta));
                }
            }

            // Lore
            if (meta.hasLore()) {
                section.set("lore", EnchantedMobs.methodUtil.getItemLore(meta));
            }
            ...
            if (meta instanceof SkullMeta) {
                ...
                String textureValue = EnchantedMobs.methodUtil.serializeSkull(skullMeta);
